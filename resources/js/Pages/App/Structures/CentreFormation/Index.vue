            ...
            <v-container>
                ...
                >
                    ...
                    <template v-slot:item.actions="{ item }">
                        <inertia-link class="mx-auto" :href="`/app/fede/structures/centre-formation/${item.id}`" ><v-icon small class="mr-2" >mdi-eye</v-icon></inertia-link>
...
export default {
    ...
    methods: {
        editItem(item){
            console.log(item);
            Inertia.post(`/app/fede/structures/centre-formation/edit`, {
                _method: 'post',
                club: item,
            });
        },
        deleteItem(item){
            ...
            Inertia.post(`/app/fede/structures/centre-formation/${item}`, {
                _method: 'delete'
            });
        }
    },
