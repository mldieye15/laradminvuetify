                                ...
                                <v-container>
                                    ...
                                    <v-row>
                                        <v-col cols="12" sm="12" md="6" >
                                            <v-select v-model="selectedCommune" :items="communes" label="Commune" item-text="sigle" item-value="id" single-line return-object></v-select>
                                        </v-col>
                                        <v-col cols="12" sm="12" md="6" >
...
export default {
    ...
    props:  ['quartiers', 'errors', 'communes'],
    data () {
      return {
        items: [
            {
    ...
    methods: {
        ...
        editItem (item) {
            this.editedIndex = this.quartiers.indexOf(item)
            this.selectedCommune = JSON.parse(this.quartiers[this.editedIndex].commune);
        ...
        deleteItemConfirm () {
            this.$inertia.delete(`/app/intial-data/quartiers/${this.quartiers[this.editedIndex].id}`);
            this.listeQuartier.splice(this.editedIndex, 1)
            this.closeDelete()
        },
