                                ...
                                <v-container>
                                    ...
                                    <v-row>
                                        <v-col cols="12" sm="12" md="6" >
                                            <v-select v-model="selectedRegion" :items="regions" label="Région" item-text="sigle" item-value="id" single-line return-object></v-select>
                                        </v-col>
                                        <v-col cols="12" sm="12" md="6" >
    ...
    methods: {
        save () {
            if (this.editedIndex > -1) {
                Object.assign(this.departements[this.editedIndex], this.form);
                Inertia.post(`/app/intial-data/departements/${this.form.id}`, {
                    _method: 'put',
                ...
                Inertia.post(`/app/intial-data/departements`, {
                    _method: 'post',
                    libelle: this.form.libelle,
                    sigle: this.form.sigle,
                    codification: this.form.codification,
        ...
        editItem (item) {
            ...
            this.selectedRegion = JSON.parse(this.departements[this.editedIndex].region);
        ...
        deleteItemConfirm () {
            this.$inertia.delete(`/app/intial-data/departements/${this.departements[this.editedIndex].id}`);
