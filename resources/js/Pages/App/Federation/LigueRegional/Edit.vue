<template >
    <AppLayout>
        ...
        <v-card>
            <v-card-title>
                <span class="text-h5">Edition ligue régionle</span>
            </v-card-title>
            <v-card-text>
                <v-container>
                    <v-row>
            ...
            <v-card-actions class="btn-to-top">
                ...
                <inertia-link class="mx-auto" :href="route('ligregio.index')" color="red darken-1">
...
export default {
    ...
    data () {
      return {
        ...
        form: this.$inertia.form({
            libelle: null,//this.ligueRegionale.Libelle,
            sigle: null,
            email: null,
            adresse: '',
            telephone: '',
    ...
    created () {
        this.form = Object.assign({}, this.ligueRegionale[0]);
        //console.log(this.form);
    },

    methods: {
        save () {
            Inertia.post(`/app/fede/lig-regio/${this.form.id}`, {
                _method: 'put',
            ...
            /*if (this.editedIndex > -1) {
                ...
                Inertia.post(`/app/fede/lig-regio`, {
                    _method: 'post',
                    libelle: this.form.libelle,
                    sigle: this.selectedRegion.sigle,
                    adresse: this.form.adresse,
                    telephone: this.form.telephone,
                    email: this.form.email,
                    date_creation: this.form.date_creation,
