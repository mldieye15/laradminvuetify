...
use App\Models\User\Autorisation;

class AutorisationRepository {

    /**
     * @var App\Models\User\Autorisation
    */
    protected $model;

    /**
     * AutorisationRepository constructor
     *
     * @param App\Models\User\Autorisation $model
    */
    public function __construct(Autorisation $model){
        $this->model = $model;
    }
     ...
     *
     * @return App\Models\User\Autorisation $model
     */
