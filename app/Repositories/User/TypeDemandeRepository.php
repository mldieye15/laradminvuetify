...
class TypeDemandeRepository {
    ...
    /**
     * @var App\Models\User\TypeDemande
    */
    protected $model;
     ...
     *
     * @param App\Models\User\TypeDemande $model
    */
    public function __construct(TypeDemande $model){
        $this->model = $model;
    }
     ...
     *
     * @return App\Models\User\TypeDemande $model
     */
    ...
    /**
     * Enregistrer un type de demande
     *
     * @param $data
     * @return App\Models\User\TypeDemande
     */
