...
use App\Repositories\Params\CotePratiquantRepository;
use Exception;
use Illuminate\Support\Facades\Storage;
use InvalidArgumentException;

class CotePratiquantService {
    ...
    */
    ...
    /**
     * CotePratiquantService constructor
     *
     * @param App\Repositories\Params\CotePratiquantRepository $dao
    */
    public function __construct(CotePratiquantRepository $dao){
        $this->dao = $dao;
    }

    /**
     * Retourne toutes les cotés des joueurs.
     *
     * @return String
     */
    ...
    /**
     * Retourne un côté avec toutes les informations.
     *
     * @return String
     */
    ...
    /**
     * Recupérer une fonction pratiquant par son id.
     *
     * @param $id
     * @return String
     */
