...
class ClubService {
    ...
    /**
     * @var App\Repositories\Structures\ClubRepository
    */
    protected $dao;
     ...
     *
     * @param App\Repositories\Structures\ClubRepository $dao
    */
    public function __construct(ClubRepository $dao){
        $this->dao = $dao;
    }
    ...
    public function allFormatted()
    {
        return $this->dao->getAll()->map(function ($item){
            return [
                ...
                'tiktok' => $item->tiktok,
                'logo' => asset('storage/clubs/'.$item->logo),
    ...
    /**
     * Retourne tous les clubs avec le minimum d'infomation selon la ligue .
     *
     * @param $ligue
     * @return String
     */
    ...
    {
        return $this->dao->minimalClubByLigue($ligue);
    }
}
