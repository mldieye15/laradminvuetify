...
use App\Services\User\AutorisationService;
...
protected $demandeService;
   ...
   *
   * @param App\Services\User\AutorisationService $service
   ...
   *
   */
  public function __construct(AutorisationService $service,
                              LigueRegionaleService $ligueService,
   ...
   */
   public function index(){
       ...
       return Inertia::render('App/User/Autorisation/Index', [
           'personnes' => $personnes,
   ...
   */
   public function create(){
       ...
       return Inertia::render('App/User/Autorisation/New', [
           'pays' => $pays,
   ...
   */
   public function edit(Request $request){
       ...
       return Inertia::render('App/User/Autorisation/Edit', [
           'personne' => $personne,
           'pays' => $pays
       ]);
   }
   ...
   */
   public function show($id){
       ...
       return Inertia::render('App/User/Autorisation/Details', [
           'personne' => $personne,
       ]);
   }
